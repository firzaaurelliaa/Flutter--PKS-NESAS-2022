...
class EditFutsal extends StatefulWidget {
  const EditFutsal({Key? key}) : super(key: key);

  @override
  State<EditFutsal> createState() => _EditFutsalState();
}
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        const Icon(Icons.add_photo_alternate, size: 70),
