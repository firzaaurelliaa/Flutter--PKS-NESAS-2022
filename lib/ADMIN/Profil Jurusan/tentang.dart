...
import 'package:akhir/Admin/Profil%20Jurusan/edit_tentang.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class Tentang extends StatefulWidget {
  final DocumentSnapshot? dataJurusan;
  const Tentang({Key? key, this.dataJurusan}) : super(key: key);
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Expanded(
                        child: Text(
                          snapshot.data!.docs[index]['tentangJurusan'],
