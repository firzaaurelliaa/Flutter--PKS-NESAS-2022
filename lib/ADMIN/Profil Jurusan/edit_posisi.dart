...
class EditPosisi extends StatefulWidget {
  DocumentSnapshot docid;
  EditPosisi({Key? key, required this.docid}) : super(key: key);

  @override
  _EditPosisiState createState() => _EditPosisiState();
}

class _EditPosisiState extends State<EditPosisi> {
