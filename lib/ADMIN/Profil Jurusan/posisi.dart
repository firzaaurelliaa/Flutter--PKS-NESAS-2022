...
import 'package:akhir/Admin/Profil%20Jurusan/edit_posisi.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class Posisi extends StatefulWidget {
  final DocumentSnapshot? dataJurusan;
  const Posisi({Key? key, this.dataJurusan}) : super(key: key);

  @override
  State<Posisi> createState() => _PosisiState();
}
