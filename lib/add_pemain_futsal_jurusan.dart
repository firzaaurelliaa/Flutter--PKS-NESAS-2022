...
class AddPemainFutsalJurusan extends StatefulWidget {
  final String id;
  const AddPemainFutsalJurusan({Key? key, required this.id}) : super(key: key);

  // DocumentSnapshot docid;
  // AddPemain({Key? key, required this.docid}) : super(key: key);

  @override
  _AddPemainFutsalJurusanState createState() => _AddPemainFutsalJurusanState();
}
