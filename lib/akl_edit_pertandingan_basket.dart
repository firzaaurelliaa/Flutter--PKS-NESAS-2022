...
class AklEditPertandinganBasket extends StatefulWidget {
  const AklEditPertandinganBasket({Key? key}) : super(key: key);

  @override
  State<AklEditPertandinganBasket> createState() =>
      _AklEditPertandinganBasketState();
}

class _AklEditPertandinganBasketState extends State<AklEditPertandinganBasket> {
            ...
            child: TextButton(
                onPressed: () => {
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const AklEditPertandinganBasket(),
                        ),
                      ),
                    },
                child: const Text(
