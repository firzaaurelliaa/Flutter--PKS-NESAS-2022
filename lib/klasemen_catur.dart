...
class KlasemenCatur extends StatelessWidget {
  const KlasemenCatur({Key? key}) : super(key: key);
            ...
            Stack(
              children: [
                ...
                Row(
                    ...
                    children: [
                      const Text('Klasemen Catur', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17),),
                    ],
                  ),
              ],
            ),
