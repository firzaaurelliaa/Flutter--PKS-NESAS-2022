...
class PosisiAKL extends StatefulWidget {
  final DocumentSnapshot? dataJurusan;
  const PosisiAKL({Key? key, this.dataJurusan}) : super(key: key);

  @override
  State<PosisiAKL> createState() => _PosisiAKLState();
}

class _PosisiAKLState extends State<PosisiAKL> {
  @override
