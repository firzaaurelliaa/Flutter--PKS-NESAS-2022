...
class UserStatistik extends StatefulWidget {
  final String docId;
  const UserStatistik({Key? key, required this.docId}) : super(key: key);

  @override
  State<UserStatistik> createState() => _UserStatistikState();
}

class _UserStatistikState extends State<UserStatistik> {
