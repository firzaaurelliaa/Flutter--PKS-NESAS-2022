...
class UserAKLTentang extends StatefulWidget {
  final DocumentSnapshot? dataJurusan;
  const UserAKLTentang({Key? key, this.dataJurusan}) : super(key: key);

  @override
  State<UserAKLTentang> createState() => _UserAKLTentangState();
}

class _UserAKLTentangState extends State<UserAKLTentang> {
  @override
