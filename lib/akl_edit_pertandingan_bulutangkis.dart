...
class AklEditPertandinganBulutangkis extends StatefulWidget {
  const AklEditPertandinganBulutangkis({Key? key}) : super(key: key);

  @override
  State<AklEditPertandinganBulutangkis> createState() =>
      _AklEditPertandinganBulutangkisState();
}

class _AklEditPertandinganBulutangkisState extends State<AklEditPertandinganBulutangkis> {
            ...
            child: TextButton(
                onPressed: () => {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AKLPertandinganBulutangkis(),
                        ),
                      ),
                    },
                child: const Text(
