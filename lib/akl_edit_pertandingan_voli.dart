...
class AklEditPertandinganVoli extends StatefulWidget {
  const AklEditPertandinganVoli({Key? key}) : super(key: key);

  @override
  State<AklEditPertandinganVoli> createState() =>
      _AklEditPertandinganVoliState();
}

class _AklEditPertandinganVoliState extends State<AklEditPertandinganVoli> {
            ...
            child: TextButton(
                onPressed: () => {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PilihanPertandingan(),
                        ),
                      ),
                    },
                child: const Text(
