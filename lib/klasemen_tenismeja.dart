...
class KlasemenTenismeja extends StatelessWidget {
  const KlasemenTenismeja({Key? key}) : super(key: key);
            ...
            Stack(
              children: [
                ...
                Row(
                    ...
                    children: [
                      const Text('Klasemen Tenis Meja', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17),),
                    ],
                  ),
              ],
            ),
