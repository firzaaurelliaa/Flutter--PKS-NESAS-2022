...
class AklEditPertandinganCatur extends StatefulWidget {
  const AklEditPertandinganCatur({Key? key}) : super(key: key);

  @override
  State<AklEditPertandinganCatur> createState() =>
      _AklEditPertandinganCaturState();
}

class _AklEditPertandinganCaturState extends State<AklEditPertandinganCatur> {
            ...
            child: TextButton(
                onPressed: () => {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AKLPertandinganCatur(),
                        ),
                      ),
                    },
                child: const Text(
