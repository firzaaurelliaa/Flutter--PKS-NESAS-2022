...
class KlasemenVoli extends StatelessWidget {
  const KlasemenVoli({Key? key}) : super(key: key);
            ...
            Stack(
              children: [
                ...
                Row(
                    ...
                    children: [
                      const Text('Klasemen Voli', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 17),),
                    ],
                  ),
              ],
            ),
