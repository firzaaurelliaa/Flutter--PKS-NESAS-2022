...
class FormListPertandingan extends StatefulWidget {
  DocumentSnapshot docid;
  final String id;

  FormListPertandingan({
    Key? key,
    required this.docid,
    required this.id,
  }) : super(key: key);
  ...
  @override
  _FormListPertandinganState createState() => _FormListPertandinganState();
}

class _FormListPertandinganState extends State<FormListPertandingan> {
