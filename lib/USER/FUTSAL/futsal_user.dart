...
import 'package:akhir/OOP_Custom_Widgets.dart/card_score_oop.dart';
import 'package:akhir/USER/FUTSAL/Lihat%20Detail/lihat_detail_user.dart';
                        ...
                        TextButton(
                            onPressed: () => {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => TabbarLihatDetailUser(
